...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_delta = error # * final_outputs * (1 - final_outputs)
        ...
        output_error_term = output_delta
        
        hidden_error_term = hidden_delta
        ...
        delta_weights_i_h += -np.dot(X.T, hidden_delta)
        # Weight step (hidden to output)
        delta_weights_h_o += -np.dot(hidden_outputs.T, output_delta)
